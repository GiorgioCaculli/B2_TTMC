...
public class MainGui extends Application {
		...
		jr.getBtnVal().setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				if(jr.getTxtRep().getText().equalsIgnoreCase(bc.getQuestions().get(id).getAnswer())) {
					Alert alert = new Alert(AlertType.INFORMATION, "Brava tu as r�ussi !");
					...
					Alert alert = new Alert(AlertType.INFORMATION, "Tu as rat� tu es une merde!\nLa r�ponse �tait : "+bc.getQuestions().get(id).getAnswer());
					alert.setTitle("Resultats");
	...
	public void GenererDeck() {
		...
		Question q1= new Question("Guillaume", Theme.IMPROBABLE, "Test", "Billy est-il d�biles?1", "Oui");
		Question q2= new Question("Guillaume", Theme.IMPROBABLE, "Test", "Billy est-il d�biles?2", "non");
		Question q3= new Question("Guillaume", Theme.IMPROBABLE, "Test", "Billy est-il d�biles?3", "Peut-etre");
		Question q4= new Question("Guillaume", Theme.IMPROBABLE, "Test", "Billy est-il d�biles?4", "surement");
		bc.add(q1);
		bc.add(q2);
		bc.add(q3);
		bc.add(q4);
